...
| V. The Provider Is The Rate Arbiter | Not yet built — lands when an LLM provider is wired in (notebook 02+): no internal concurrency cap below OpenAI's actual limit, rely on LangChain's retry/backoff | — |
